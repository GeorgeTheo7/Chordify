...
start() {
    ...
    do
        ...
        do
            set_port="export CHORDIFYSERVER_PORT=500$((n - 1))"
            ssh user@node$i "sh -c 'nohup $chordify 500$((n - 1)) $1 $2 > /dev/null 2>&1 &'"
